				...
				Findings: []model.Finding{
					{
						...
						ChainableEntrypoint: &model.ChainableEntrypoint{
							...
							QualificationReasonCodes: []string{"active-finding", "asset-internet-accessible", "possible-candidate"},
							PolicyVersion:            "chainable-entrypoint-v1",
						},
...
func TestToCycloneDXVDRProperties(t *testing.T) {
	...
	wantVuln := map[string]string{
		...
		"vdr:chainableEntrypointQualification":        "review",
		"vdr:chainableEntrypointQualifies":            "false",
		...
		"vdr:chainableEntrypointQualificationReasons": "active-finding,asset-internet-accessible,possible-candidate",
		"vdr:chainableEntrypointPolicy":               "chainable-entrypoint-v1",
